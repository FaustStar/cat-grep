...
for file in $test_data/*.txt; do
    for flag in -i -v -c -l -n -o -iv -vo -vc -vn -vl -lcin -cinv -onc -nocvi -nocvil; do
...
for flag in -i -v -c -l -n -h -iv -vho -vc -vnh -vl -lcino -cinv -nco -ncvoi -ncviol -lh -hnoc -ncvih -cnhilv; do
